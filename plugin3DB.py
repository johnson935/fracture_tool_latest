...
RsgComboBox(name='ComboBox_4', p='TabItem_4', text='Units', keyword='unit', default='meter', comboType='STANDARD', repository='', rootText='', rootKeyword=None, layout='')
...
RsgHorizontalFrame(name='HFrame_5', p='TabItem_2', layout='0', pl=0, pr=0, pt=15, pb=0)
...
RsgHorizontalFrame(name='HFrame_6', p='GroupBox_7', layout='0', pl=0, pr=0, pt=15, pb=0)
